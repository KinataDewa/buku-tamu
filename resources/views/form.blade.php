                        ...
                        <div class="card-body">
                            ...
                            <form id="formTamu" method="POST" action="{{ route('form.store') }}" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" name="telepon" placeholder="08xxxxxxxxxx" value="{{ old('telepon') }}"
                                        required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="jam_kunjungan" id="jam_kunjungan" readonly>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="button" id="btnKamera" class="btn btn-secondary" onclick="toggleKamera()">Aktifkan
                                            Kamera</button>
                                        <button type="button" id="btnAmbil" class="btn btn-success" onclick="ambilFoto()" disabled>Ambil
                                            Foto</button>
                                    </div>
                                </div>
    ...
    <script>
        function handleKeperluanChange() {
            ...
            if (keperluan === 'FAT') {
                ...
                if (jenisTamuSelect.value === 'Tamu Tenant') {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Isi jam kunjungan otomatis saat halaman dimuat
            ...
            document.getElementById('jenis_tamu').addEventListener('change', function () {
                ...
                jenisTamuHidden.value = jenis;

                if (keperluan === 'lainnya' || jenis === 'Tamu Tenant') {
                    namaPenerimaWrapper.style.display = 'block';
                    namaPenerimaInput.value = '';
                } else {
                    namaPenerimaWrapper.style.display = 'none';
