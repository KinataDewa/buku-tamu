...
<div class="container mt-4">
        <h1 class="page-title mb-4" style="font-family: 'Poppins', sans-serif;">Form Buku Tamu</h1>
                    ...
                    <form id="formTamu" method="POST" action="{{ route('form.store') }}" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="keperluan" id="keperluan" required onchange="handleKeperluanChange()">
                                ...
                                <option value="FAT" {{ old('keperluan') == 'FAT' ? 'selected' : '' }}>Tukar Faktur (FAT)</option>
                                <option value="janji" {{ old('keperluan') == 'janji' ? 'selected' : '' }}>Janji Ketemu</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img id="previewFoto" class="img-thumbnail mb-2" 
                                style="width: 100%; max-width: 100%; max-height: 300px; object-fit: cover; display: none;" 
                                alt="Preview Foto">
